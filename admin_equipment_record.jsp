...
<div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <button type="submit" class="btn btn-submit"><a href="admin_add_equipment_record.jsp">Add Equipment</a></button>
      </div>
         &nbsp;&nbsp;&nbsp;
      <div class="col-sm-offset-2 col-sm-10">
        <button type="clear" class="btn btn-default">Remove Equipment</button>
      </div>
