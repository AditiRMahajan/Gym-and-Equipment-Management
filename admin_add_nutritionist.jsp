    ...
    <div class="row">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12">
        <ul class="breadcrumb">
          <li><a href="admin_index.jsp">home</a></li>
          <li>//</li>
          <li><a href="admin_about.jsp">Nutritionist</a></li>
        </ul>
      </div>
    </div>
  </div>
...
<div class="container">
  <h2> </h2>
  <br><br>
  <form class="form-horizontal" action="nut_entries.jsp" method="post">
    <div class="form-group">
      <label class="control-label col-sm-2" for="">NUTRITIONIST ID:</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" id="" placeholder="Enter nutritionist id" name="nutritionist_id">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="">NUTRITIONIST NAME:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="" placeholder="Enter nutritionist name" name="nutritionist_name">
      </div>
    </div>
     <div class="form-group">
      <label class="control-label col-sm-2" for="">VISITING HOURS:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="" placeholder="Enter visiting hours" name="visiting_hours">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="">CONATCT NO:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="" placeholder="Enter contact number" name="nutritionist_contact_no">
      </div>
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <button type="submit" class="btn btn-default">Submit</button>
         ...
         &nbsp;
      <div class="col-sm-offset-2 col-sm-10">
        <button type="clear" class="btn btn-default"><a href="admin_add_nutritionist.jsp">clear</a></button>
      </div>
    </div>
  </form>
</div>
