		...
		<div class="row">
			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				<ul class="breadcrumb">
					<li><a href="admin_index.jsp">home</a></li>
					<li>//</li>
					<li><a href="admin_equipment_details.jsp">Equipment</a></li>
				</ul>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="gm_service_box">
					<div class="gm_service_img">
						<img src="images/content/treadmill.jpg" alt="classes" title="classes">
					</div>
					<div class="gm_service_info">
						<h3>4 in 1 Deluxe Treadmill</h3>
                                                &nbsp;
						<ol>
                                                    
                                                    <li>ID : eq101</li>
					            <li>MANUFACTURE DATE : 2015-05-26</li>
					            <li>PURCHASE DATE : 2016-05-11</li>
                                                    <li>COST : 15000</li>
                                                    <li>WARRANTY : 5 years</li>
                                                    <li>MAINTENANCE PERIOD : 3 months</li>
                                                    <li>CLEANING PERIOD : weekly</li>
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="gm_service_box">
					<div class="gm_service_img">
						<img src="images/content/Airbike.jpg" alt="classes" title="classes">
					</div>
					<div class="gm_service_info">
						<h3>Air Bike</h3>
                                                &nbsp;
						<ol>
                                                    ...
                                                    <li>ID : eq102</li>
					            <li>MANUFACTURE DATE : 2016-05-03</li>
					            <li>PURCHASE DATE : 2016-05-28</li>
                                                    <li>COST : 9000</li>
                                                    <li>WARRANTY : 4 years</li>
                                                    <li>MAINTENANCE PERIOD : 4 months</li>
                                                    <li>CLEANING PERIOD : monthly</li>
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="gm_service_box">
					<div class="gm_service_img">
						<img src="images/content/roller set.jpg" alt="classes" title="classes">
					</div>
					<div class="gm_service_info">
						<h3>Ab wheel roller set</h3>
                                                &nbsp;
						<ol>
                                                    
                                                    <li>ID : eq103</li>
					            <li>MANUFACTURE DATE : 2017-12-26</li>
					            <li>PURCHASE DATE : 2018-05-28</li>
                                                    <li>COST : 5000</li>
                                                    <li>WARRANTY : 3 years</li>
                                                    <li>MAINTENANCE PERIOD : 6 months</li>
                                                    <li>CLEANING PERIOD : monthly</li>
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="gm_service_box">
					<div class="gm_service_img">
						<img src="images/content/dumbbell.jpg" alt="classes" title="classes">
					</div>
					<div class="gm_service_info">
						<h3>Dumbbell set</h3>
                                                &nbsp;
						<ol>
                                                    ...
                                                    <li>ID : eq104</li>
					            <li>MANUFACTURE DATE : 2018-06-26</li>
					            <li>PURCHASE DATE : 2018-09-11</li>
                                                    <li>COST : 8800</li>
                                                    <li>WARRANTY : 8 years</li>
                                                    <li>MAINTENANCE PERIOD : yearly</li>
                                                    <li>CLEANING PERIOD : 6 months</li>
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="gm_service_box">
					<div class="gm_service_img">
						<img src="images/content/ball.jpg" alt="classes" title="classes">
					</div>
					<div class="gm_service_info">
						<h3>Physio excercise balls</h3>
                                                &nbsp;
						<ol>
                                                    
                                                    <li>ID : eq105</li>
					            <li>MANUFACTURE DATE : 2017-02-08</li>
					            <li>PURCHASE DATE : 2018-06-21</li>
                                                    <li>COST : 7000</li>
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="gm_service_box">
					<div class="gm_service_img">
						<img src="images/content/lat-pulldown.jpg" alt="classes" title="classes">
					</div>
					<div class="gm_service_info">
						...
						<ol>
                                                    ...
                                                    <li>ID : eq106</li>
					            <li>MANUFACTURE DATE : 2015-12-26</li>
					            <li>PURCHASE DATE : 2016-05-28</li>
                                                    <li>COST : 20000</li>
                                                    <li>WARRANTY : 5 years</li>
                                                    <li>MAINTENANCE PERIOD : 6 months</li>
