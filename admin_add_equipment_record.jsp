    ...
    <div class="row">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12">
        <ul class="breadcrumb">
          <li><a href="admin_index.jsp">home</a></li>
          <li>//</li>
          <li><a href="admin_add_equipment.jsp">Equipment</a></li>
        </ul>
      </div>
    </div>
  </div>
...
<div class="container">
  <h2> </h2>
  <br><br>
  <form class="form-horizontal" action="equipment_entries.jsp" method="post">
    <div class="form-group">
      <label class="control-label col-sm-2" for="">EQUIPMENT ID:</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" id="" placeholder="Enter Equipment Id" name="equipment_id">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="">EQUIPMENT NAME:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="" placeholder="Enter Equipment Name" name="equipment_name">
      </div>
    </div>
     <div class="form-group">
      <label class="control-label col-sm-2" for="">MANUFACTURE DATE:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="" placeholder="Enter Manufacture Date" name="manufacture_date">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="">PURCHASE DATE:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="" placeholder="Enter Purchase Date" name="purchase_date">
      </div>
    </div>
   <div class="form-group">
      <label class="control-label col-sm-2" for="">EQUIPMENT COST:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="" placeholder="Enter Equipment Cost" name="equipment_cost">
      </div>
    </div>
   <div class="form-group">
      <label class="control-label col-sm-2" for="">EQUIPMENT WARRANTY:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="" placeholder="Enter Equipment Warranty" name="equipment_warranty">
      </div>
    </div>
   <div class="form-group">
      <label class="control-label col-sm-2" for="">MAINTENANCE PERIOD:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="" placeholder="Enter Maintenance Period" name="maintainance_period">
      </div>
    </div>
   <div class="form-group">
      <label class="control-label col-sm-2" for="">CLEANING PERIOD:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="" placeholder="Enter Cleaning Period" name="cleaning_period">
      </div>
    </div>
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <button type="submit" class="btn btn-default">Submit</button>
         ...
         &nbsp;
      <div class="col-sm-offset-2 col-sm-10">
        <button type="clear" class="btn btn-default"><a href="equipment_entries.jsp">clear</a></button>
      </div>
    </div>
  </form>
</div>
