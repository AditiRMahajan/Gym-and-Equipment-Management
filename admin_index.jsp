	...
	<div class="container">
		<div class="row">
			<div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
				<div class="gm_logo">
                                    <a href="admin_index.jsp"><h1>GEMS FIT</h1></a>
				...
				<div class="gm_slider">
					...
					<!-- START REVOLUTION SLIDER 5.3.0.2 fullwidth mode -->
						<div id="rev_slider_1078_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.3.0.2">
							<ul>	<!-- SLIDE  -->
								<li data-index="rs-3045" data-transition="zoomout" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="images/slider/sl1_100x50.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Strength" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
									<!-- MAIN IMAGE -->
									<img src="images/slider/sl1.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
									<!-- LAYERS -->
								...
								<!-- SLIDE  -->
								<li data-index="rs-3046" data-transition="fadetotopfadefrombottom" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power3.easeInOut" data-easeout="Power3.easeInOut" data-masterspeed="1500"  data-thumb="images/slider/sl2_100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Heavy" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
									<!-- MAIN IMAGE -->
									<img src="images/slider/sl2.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
									<!-- LAYERS -->
							...
							<div class="rs-looped rs-wave"  data-speed="4" data-angle="0" data-radius="10" data-origin="50% 50%"><img src="images/slider/blurflake1.png" alt="" data-ww="['120px','120px','120px','120px']" data-hh="['120px','120px','120px','120px']" width="120" height="120" data-no-retina> </div></div>
								...
								<!-- SLIDE  -->
								<li data-index="rs-3049" data-transition="zoomin" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="images/slider/sl3_100x50.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Results" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
									<!-- MAIN IMAGE -->
									<img src="images/slider/sl3.jpg"  alt=""  data-bgposition="center center" data-kenburns="on" data-duration="10000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 -500" data-offsetend="0 500" data-bgparallax="10" class="rev-slidebg" data-no-retina>
									<!-- LAYERS -->
			...
			<div class="gm_bnr_infowrapper">
				...
				<div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
					<div class="gm_bnr_form">
						...
						<form>
							<input type="text" placeholder="Email" name="email" class="require">
							<input type="text" placeholder="Password" name="password" class="require">						
							
							<div class="response"></div>
							<button type="button" class="gm_btn submitForm" data-form-type="inquiry">SIGN IN</button>
						</form>
					</div>
				</div>
			</div>
...
<!--Offer section start-->
<!--We Do section start-->
<div class="gm_wedo_wrapper gm_toppadder80 gm_bottompadder30">
	<div class="container">
		<div class="row">
...
<div class="gm_service_wrapper gm_toppadder80 gm_bottompadder50">
	<div class="container">
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-lg-offset-3 col-md-offset-3">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="gm_service_box">
					<div class="gm_service_img">
						<img src="images/content/service1.jpg" alt="classes" title="classes">
					</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="gm_service_box">
					<div class="gm_service_img">
						<img src="images/content/service2.jpg" alt="classes" title="classes">
					</div>
					<div class="gm_service_info">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="gm_service_box">
					<div class="gm_service_img">
						<img src="images/content/service3.jpg" alt="classes" title="classes">
					</div>
					<div class="gm_service_info">
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="gm_price_box">
					<h5>3 months</h5>
					<h1><sup>RS</sup>2k<sub>/mon</sub></h1>
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="gm_price_box">
					<h5>half yearly</h5>
					<h1><sup>RS</sup>5k<sub>/mon</sub></h1>
					<p>Over Cardio Pieces</p>
					<ul>
						<li>Attend any daily group session</li>
						<li>No booking required</li>
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="gm_price_box">
					<h5>yearly</h5>
					<h1><sup>RS</sup>10k<sub>/year</sub></h1>
					<p>Over Cardio Pieces</p>
					<ul>
						<li>Attend any daily group session</li>
						<li>No booking required</li>
		...
		<div class="row">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="gm_team_box">
					<img src="images/content/tm1.png" alt="Trainer" title="Trainer">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="gm_team_box">
					<img src="images/content/tm2.png" alt="Trainer" title="Trainer">
					<div class="gm_team_info">
						<h4>Ethan Fulton</h4>
						<p>trainer</p>
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="gm_team_box">
					<img src="images/content/tm3.png" alt="Trainer" title="Trainer">
					<div class="gm_team_info">
						<h4>Kathy Burns</h4>
						<p>trainer</p>
			...
			<div class="gm_gallery_box popup-gallery">
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
					<div class="gm_gallery_boxes">
						<a href="images/content/glr01.jpg" title=""><img src="images/content/glr1.jpg" alt="item1" class="img-responsive"></a>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
					<div class="gm_gallery_boxes">
						<a href="images/content/glr02.jpg" title=""><img src="images/content/glr2.jpg" alt="item2" class="img-responsive"></a>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
					<div class="gm_gallery_boxes">
						<a href="images/content/glr03.jpg" title=""><img src="images/content/glr3.jpg" alt="item3" class="img-responsive"></a>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
					<div class="gm_gallery_boxes">
						<a href="images/content/glr04.jpg" title=""><img src="images/content/glr4.jpg" alt="item4" class="img-responsive"></a>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
					<div class="gm_gallery_boxes">
						<a href="images/content/glr05.jpg" title=""><img src="images/content/glr5.jpg" alt="item5" class="img-responsive"></a>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
					<div class="gm_gallery_boxes">
						<a href="images/content/glr06.jpg" title=""><img src="images/content/glr6.jpg" alt="item6" class="img-responsive"></a>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
					<div class="gm_gallery_boxes">
						<a href="images/content/glr07.jpg" title=""><img src="images/content/glr7.jpg" alt="item7" class="img-responsive"></a>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
					<div class="gm_gallery_boxes">
						<a href="images/content/glr08.jpg" title=""><img src="images/content/glr8.jpg" alt="item8" class="img-responsive"></a>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
					<div class="gm_gallery_boxes">
						<a href="images/content/glr09.jpg" title=""><img src="images/content/glr9.jpg" alt="item9" class="img-responsive"></a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<div class="gm_footer_menu gm_single_index_menu">
					<ul>
						<li><a href="admin_index.jsp">home</a></li>
						<li><a href="admin_classes.jsp">classes</a></li>
						<li><a href="admin_packages.jsp">Packages</a></li>
						<li><a href="admin_gallery.jsp">gallery</a></li>
						<li><a href="admin_contact.jsp">contact us</a></li>
					</ul>
