    ...
    <div class="row">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12">
        <ul class="breadcrumb">
          <li><a href="admin_index.jsp">home</a></li>
          <li>//</li>
          <li><a href="admin_about.jsp">Trainer</a></li>
        </ul>
      </div>
    </div>
  </div>
...
<div class="container">
  <h2> </h2>
  <br><br>
  <form class="form-horizontal" action="trainer_entries.jsp" method="post">
    <div class="form-group">
      <label class="control-label col-sm-2" for="">TRAINER ID:</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" id="" placeholder="Enter trainer id" name="trainer_id">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="">TRAINER NAME:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="" placeholder="Enter trainer name" name="trainer_name">
      </div>
    </div>
     <div class="form-group">
      <label class="control-label col-sm-2" for="">TRAINER CONTACT NO:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="" placeholder="Enter trainer contact no" name="trainer_contact_no">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="">TRAINER BATCH NAME:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="" placeholder="Enter trainer batch name" name="t_batch_name">
      </div>
    </div>
   <div class="form-group">
      <label class="control-label col-sm-2" for="">TRAINER BATCH TIME:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="" placeholder="Enter trainer batch time" name="t_batch_no">
      </div>
    </div>
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <button type="submit" class="btn btn-default">Submit</button>
         ...
         &nbsp;
      <div class="col-sm-offset-2 col-sm-10">
        <button type="clear" class="btn btn-default"><a href="admin_add_trainer.jsp">clear</a></button>
      </div>
    </div>
  </form>
</div>
