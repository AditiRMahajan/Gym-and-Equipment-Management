    ...
    <div class="row">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12">
        <ul class="breadcrumb">
          <li><a href="admin_index.jsp">home</a></li>
          <li>//</li>
          <li><a href="admin_members.jsp">Member</a></li>
        </ul>
      </div>
    </div>
  </div>
...
<div class="container">
  <h2> </h2>
  <br><br>
  <form class="form-horizontal" action="SignUpServlet.jsp" method="post">
    <div class="form-group">
      <label class="control-label col-sm-2" for="">MEMBER ID:</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" id="" placeholder="Enter Member id" name="member_id">
      </div>
    </div>
      <div class="form-group">
      ...
      <div class="form-group">
      <label class="control-label col-sm-2" for="">RE ENTER PASSWORD:</label>
      <div class="col-sm-10">
        <input type="password" class="form-control" id="" placeholder="Re Enter password" name="re_enter_password">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="">MEMBER NAME:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="" placeholder="Enter Member name" name="member_name">
      </div>
    </div>
     <div class="form-group">
      <label class="control-label col-sm-2" for="">DATE OF BIRTH:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="" placeholder="Enter Date of birth" name="date_of_birth">
      </div>
    </div>
     <div class="form-group">
    ...
    <div class="form-group">
      <label class="control-label col-sm-2" for="">MEMBER ADDRESS:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="" placeholder="Enter Member Address" name="member_address">
      </div>
    </div>
     <div class="form-group">
      <label class="control-label col-sm-2" for="">MEMBER CONTACT NO:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="" placeholder="Enter contact no" name="member_contact_no">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for="">PACKAGE:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="" placeholder="Enter Packages" name="Packages">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2" for=""> BATCH NAME:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="" placeholder="Enter batch name" name="batch_name">
      </div>
    </div>
   <div class="form-group">
      <label class="control-label col-sm-2" for=""> BATCH TIME:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="" placeholder="Enter batch time" name="batch_time">
      </div>
    </div>
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <button type="submit" class="btn btn-default">Submit</button>
         ...
         &nbsp;
      <div class="col-sm-offset-2 col-sm-10">
        <button type="clear" class="btn btn-default"><a href="admin_add_members.jsp">clear</a></button>
      </div>
    </div>
  </form>
</div>
