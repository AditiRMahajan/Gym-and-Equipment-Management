    ...
    <tbody>
         ...
         <%
                        try {
                            ...
                            String sql = "SELECT * FROM cleaning_staff";
...
<div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <button type="submit" class="btn btn-default"><a href="admin_add_cleaning_staff.jsp">Add Staff</a></button>
      </div>
    </div>

<div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <button type="submit" class="btn btn-default">Remove Staff</button>
      </div>
    </div>
