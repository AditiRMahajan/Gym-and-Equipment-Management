  ...
  <table class="table table-bordered">
    <thead>
      <tr>
        <th>trainer_id</th>
        <th>trainer_name</th>
        <th>trainer_contact_no</th>
        <th>trainer_batch_name</th>
        <th>trainer_batch_time</th>
...
<div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <button type="submit" class="btn btn-submit"><a href="admin_add_trainer.jsp">Add Trainer</a></button>
      </div>
         &nbsp;&nbsp;&nbsp;
      <div class="col-sm-offset-2 col-sm-10">
        <button type="clear" class="btn btn-default">Remove Trainer</button>
      </div>
