	...
	<div class="container">
		<div class="row">
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="gm_service_box">
					<div class="gm_service_img">
						<img src="images/content/service1.jpg" alt="batches" title="batches">
					</div>
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="gm_service_box">
					<div class="gm_service_img">
						<img src="images/content/service2.jpg" alt="batches" title="batches">
					</div>
					<div class="gm_service_info">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="gm_service_box">
					<div class="gm_service_img">
						<img src="images/content/service3.jpg" alt="batches" title="batches">
					</div>
					<div class="gm_service_info">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="gm_service_box">
					<div class="gm_service_img">
						<img src="images/content/service4.jpg" alt="batches" title="batches">
					</div>
					<div class="gm_service_info">
						<h3>running</h3>
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="gm_service_box">
					<div class="gm_service_img">
						<img src="images/content/blog1.jpg" alt="batches" title="batches">
					</div>
					<div class="gm_service_info">
						<h3>aerobics</h3>
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
				<div class="gm_service_box">
					<div class="gm_service_img">
						<img src="images/content/blog3.jpg" alt="batches" title="batches">
					</div>
					<div class="gm_service_info">
						<h3>cross fit</h3>
